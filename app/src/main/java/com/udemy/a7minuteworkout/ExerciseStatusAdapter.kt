...
import com.udemy.a7minuteworkout.databinding.ItemExerciseStatusBinding
...
class ExerciseStatusAdapter(val items: ArrayList<ExerciseModel>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // This were you want to return your ViewHolder
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when{
            // Sets a green border for the number of the exercise in the RV
            model.getIsSelected() -> {
